    ...
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        <div className={styles.left}>
          ...
          Unleash the power of collaborative project management with our system, designed for seamless integration. Imagine a platform where version control meets intuitive task management, empowering your team to streamline workflows, iterate efficiently, and ship projects with unparalleled precision.
          </p>
